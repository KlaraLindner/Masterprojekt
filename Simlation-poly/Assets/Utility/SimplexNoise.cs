...
namespace Utility {
    public static class SimplexNoise {
        ...
        private static float F2 = 0f * (Mathf.Sqrt(3f) - 1f);

        private static float G2 = (3f - Mathf.Sqrt(3f)) / 6f;
        private static float F3 = 1f / 3f;
        private static float G3 = 1f / 6f;
        private static float F4 = (Mathf.Sqrt(5f) - 1f) / 4f;
        private static float G4 = (5f - Mathf.Sqrt(5f)) / 20f;
        ...
        public static float noise(float xin, float yin) {
            ...
            float y1 = y0 - j1 + G2;
            float x2 = x0 - 1f + 2f * G2; // Offsets for last corner in (x,y) unskewed coords
